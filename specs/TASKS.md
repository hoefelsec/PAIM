...
> **FROZEN (2026-08-07).** T01–T25 are implemented and this registry has been
> imported into PAIM itself via `scripts/import-tasks.ts` (T25). Remaining
> work (T26–T82) is tracked as tasks inside PAIM. Do not edit this file; it
> is the historical source of the import.
